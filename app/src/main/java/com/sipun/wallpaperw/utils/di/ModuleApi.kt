package com.sipun.wallpaperw.utils.di

import com.google.gson.Gson
import com.google.gson.GsonBuilder
import com.sipun.wallpaperw.data.server.Api
import com.sipun.wallpaperw.utils.BASE_URL
import com.sipun.wallpaperw.utils.TIMEOUT_TIME
...
object ModuleApi
{
    ...
    @Provides
    @Singleton
    fun provideRetrofit(base_url : String, gson:Gson,client : OkHttpClient) : Api =
